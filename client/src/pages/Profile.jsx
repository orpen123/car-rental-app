...
//                 }`}
//               >
//                 {tab === 'bookings' ? `My Bookings (${bookings.length})` : 'Account'}
//               </button>
//             ))}
//           </div>
...
//                           {/* Car Image */}
//                           <div className='w-full sm:w-36 h-28 sm:h-auto bg-[#eaecf5] flex-shrink-0'>
...
//                               )}
//                               {booking.status === 'cancelled' && (
//                                 <span className='text-xs text-gray-400'>Booking cancelled</span>
//                               )}
...
//                         className='w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm text-gray-800 outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all'
//                       />
//                     </div>
//                     <div>
...
//                         className='w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm text-gray-800 outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-all placeholder-gray-300'
//                       />
//                     </div>
//                     <div>
...
//                         value={user?.email || ''}
//                         readOnly
//                         className='w-full px-4 py-3 bg-gray-100 rounded-2xl text-sm text-gray-400 outline-none cursor-not-allowed'
//                       />
//                       <p className='text-xs text-gray-300 mt-1'>Email cannot be changed</p>
//                     </div>

//                     {profileSuccess && (
//                       <div className='bg-green-50 border border-green-100 text-green-600 text-xs rounded-xl px-4 py-3 text-center flex items-center justify-center gap-2'>
...
//                     )}
//                     {profileError && (
//                       <div className='bg-red-50 border border-red-100 text-red-500 text-xs rounded-xl px-4 py-3 text-center'>
//                         {profileError}
//                       </div>
//                     )}
                          ...
                          <div className='flex-1 p-4'>
                            ...
                            <div className='flex items-center justify-between pt-3 border-t border-gray-50'>
                              ...
                              <div className='flex items-center gap-2'>
                                ...
                                {booking.status === 'completed' && (
                                  <Link to={`/cars/${booking.car?._id}`} className='text-xs px-3 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-600 font-semibold rounded-xl transition-colors'>
                                    Book Again
                                  </Link>
                                )}
                              </div>
