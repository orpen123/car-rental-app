    ...
    <div className="min-h-screen bg-white text-gray-900 pt-20 font-sans">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-50 py-24 md:py-32">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            Your trusted partner for premium car rentals — seamless experience, diverse fleet,
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-blue-600 leading-snug">
                Built to Redefine<br className="hidden sm:block" /> Car Rentals
              </h2>
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                Founded in 2020, CarRental set out to make luxury and convenience accessible to
                everyone — ensuring every journey is memorable and hassle-free.
              </p>
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                Our mission is top-tier vehicles, transparent pricing, and unparalleled support,
                making us the preferred choice for travelers and locals alike.
              </p>
              <ul className="space-y-2 pt-2">
                {['Fully insured fleet', 'No hidden charges', '24/7 customer support'].map((item) => (
      ...
      <section className="bg-slate-50 py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          {reviews.length > 0 && (
            ...
            >
              <div className="text-5xl font-black text-blue-600">{averageRating}</div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-3 pt-4 border-t border-gray-100">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-blue-600">{getUserName(review)}</p>
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-blue-100 text-sm sm:text-base mb-10 max-w-lg mx-auto">
              Explore our premium fleet and book your perfect car today.
