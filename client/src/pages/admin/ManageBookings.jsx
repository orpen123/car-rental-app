          ...
          {loading ? (
            ...
            <div className='divide-y divide-gray-100'>
              ...
              {filteredBookings.map((booking) => (
                <div key={booking._id} className='p-4 sm:p-5 hover:bg-gray-50 transition-all duration-200'>

                  <div className='flex gap-4'>

                    {/* Image */}
                    <div className='w-20 h-16 sm:w-28 sm:h-18 rounded-xl overflow-hidden bg-gray-100 flex-shrink-0'>
                      {booking.car?.images?.[0] ? (
                        <img src={booking.car.images[0]} className='w-full h-full object-cover' />
                      ) : (
                    ...
                    <div className='flex-1'>
                      ...
                      <div className='flex justify-between items-start mb-2'>
                        ...
                        <div className='flex flex-col gap-1 items-end'>
                          <span className={`text-[11px] px-2.5 py-1 rounded-full font-medium ${getStatusColor(booking.status)}`}>
                            {booking.status}
                          </span>
                          <span className={`text-[11px] px-2.5 py-1 rounded-full font-medium ${getPaymentColor(booking.paymentStatus)}`}>
                            {booking.paymentStatus}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className='flex flex-wrap items-center gap-2.5'>
                        ...
                        <button
                          onClick={() => setDeleteConfirm(booking._id)}
                          className='ml-auto px-3 py-1.5 bg-red-50 hover:bg-red-100 text-red-600 text-xs font-semibold rounded-xl shadow-sm hover:shadow'
                        >
                          Delete
                        </button>
      ...
      {deleteConfirm && (
        <div className='fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center'>
          <div className='bg-white p-6 rounded-2xl'>
            <p className='mb-4 text-sm'>Delete booking?</p>
            <div className='flex gap-2'>
              <button onClick={() => handleDelete(deleteConfirm)} className='bg-red-500 text-white px-4 py-2 rounded-xl'>
                Yes
              </button>
              <button onClick={() => setDeleteConfirm(null)} className='bg-gray-200 px-4 py-2 rounded-xl'>
                Cancel
              </button>
            </div>
          </div>
