          ...
          <div className='lg:col-span-2 space-y-4'>
            ...
            <div className='bg-white rounded-2xl shadow-sm p-5'>
              ...
              {bookedDates.length > 0 && (
                <div className='flex items-center gap-2 mb-4 text-xs text-gray-400 bg-red-50 px-3 py-2 rounded-xl'>
                  <span className='w-3 h-3 rounded-full bg-red-300 flex-shrink-0' />
                  Dates in red are already booked — please choose different dates
                </div>
              )}
