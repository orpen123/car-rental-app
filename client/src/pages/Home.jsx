...
// // ✅ react-icons — specific car type icons (install: npm install react-icons)
// import { FaCar, FaTruck, FaCarSide, FaBus } from 'react-icons/fa';
...
//   const typeOptions = [
//     { value: '',            label: 'All Types',    Icon: LayoutGrid },      // lucide (generic grid)
//     { value: 'sedan',       label: 'Sedan',        Icon: BsFillCarFrontFill }, // Bootstrap Icons — front-facing car
//     { value: 'suv',         label: 'SUV',          Icon: GiJeep },             // Game Icons — jeep/SUV silhouette
//     { value: 'truck',       label: 'Truck',        Icon: FaTruck },            // Font Awesome — pickup truck
//     { value: 'van',         label: 'Van',          Icon: PiVanFill },          // Phosphor Icons — van
//     // { value: 'coupe',       label: 'Coupe',        Icon: GiSportCar },         // Game Icons — sporty coupe shape
//     { value: 'hatchback',   label: 'Hatchback',    Icon: FaCarSide },          // Font Awesome — side profile car
//     { value: 'minibus',     label: 'Minibus',      Icon: FaBus },              // Font Awesome — bus/minibus
//   ];
...
//   // ✅ Updated formatOptionLabel — uses Icon from react-icons (rendered as component)
...
//           {[
//             { number: totalCars !== null ? `${totalCars}+` : '...', label: 'Cars Available', icon: Car },
...
//           {[
//             { step: '01', title: 'Choose a Car', desc: 'Browse our fleet and pick the perfect car for your journey.', icon: Car },
//             { step: '02', title: 'Book Online', desc: 'Select your dates and location and confirm your booking instantly.', icon: Calendar },
//             { step: '03', title: 'Hit the Road', desc: "Pick up your car and enjoy the ride. Return it when you're done.", icon: ArrowRight },
//           ].map((item, i) => {
//             const Icon = item.icon;
//             return (
//               <motion.div
