...
const Navbar = () => {
  ...
  return (
    <nav ref={navRef} className='fixed top-0 left-0 right-0 z-50 bg-white shadow-sm'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between'>
        ...
        <div className='hidden md:flex items-center gap-1 flex-1 justify-center'>
            ...
            <div key={item.key} className='relative'>
              <button
                ...
                className={`flex items-center gap-1 px-3 py-2 rounded-xl text-xs font-medium transition-all ${
                  dropdownOpen === item.key ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:text-blue-600 hover:bg-gray-50'
                }`}
              >
                {item.label}
                <svg className={`w-3 h-3 transition-transform duration-200 ${dropdownOpen === item.key ? 'rotate-180' : ''}`} fill='none' stroke='currentColor' viewBox='0 0 24 24'>
          ...
          <Link to='/' className='px-3 py-2 rounded-xl text-xs font-medium text-gray-600 hover:text-blue-600 hover:bg-gray-50 transition-all'>About</Link>
          <Link to='/' className='px-3 py-2 rounded-xl text-xs font-medium text-gray-600 hover:text-blue-600 hover:bg-gray-50 transition-all'>Contact</Link>
        </div>
        ...
        <div className='hidden md:flex items-center gap-3 flex-shrink-0'>
          {user ? (
            <div className='relative'>
              <button
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-xl text-xs font-medium transition-all ${
                  dropdownOpen === 'profile' ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50'
                }`}
              >
                ...
                <svg className={`w-3 h-3 transition-transform duration-200 ${dropdownOpen === 'profile' ? 'rotate-180' : ''}`} fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M19 9l-7 7-7-7' />
                </svg>
              </button>
              ...
              {dropdownOpen === 'profile' && (
                <div className='absolute top-full right-0 mt-1 bg-white shadow-xl rounded-2xl py-2 w-48 border border-gray-100 z-50 animate-fadeIn'>
                  ...
                  <Link to='/profile' onClick={() => setDropdownOpen(null)} className={`flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium transition-colors ${isActive('/profile') ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50'}`}>
                  ...
                  {user.role === 'admin' && (
                    <>
                      <Link to='/admin' onClick={() => setDropdownOpen(null)} className={`flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium transition-colors ${isActive('/admin') ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50'}`}>
                        <svg className='w-3.5 h-3.5 text-gray-400' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                          <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z' />
                        </svg>
                        Admin Dashboard
                      </Link>
                      <Link to='/admin/bookings' onClick={() => setDropdownOpen(null)} className={`flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium transition-colors ${isActive('/admin/bookings') ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50'}`}>
                        <svg className='w-3.5 h-3.5 text-gray-400' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                          <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' />
                        </svg>
                        Manage Bookings
                      </Link>
                      <Link to='/admin/reviews' onClick={() => setDropdownOpen(null)} className={`flex items-center gap-2.5 px-4 py-2.5 text-xs font-medium transition-colors ${isActive('/admin/reviews') ? 'text-orange-600 bg-orange-50' : 'text-gray-600 hover:text-orange-600 hover:bg-orange-50'}`}>
                  ...
                  <div className='border-t border-gray-50 mt-1 pt-1'>
                    <button onClick={handleLogout} className='w-full flex items-center gap-2.5 px-4 py-2.5 text-xs text-red-500 hover:bg-red-50 transition-colors font-medium'>
            ...
            <Link to='/login' className='flex items-center gap-1.5 text-gray-600 hover:text-blue-600 text-xs font-medium transition-colors px-3 py-2 rounded-xl hover:bg-gray-50'>
              <svg className='w-3.5 h-3.5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' />
              </svg>
              Sign in
          ...
          <Link to='/cars' className='px-4 py-2 bg-gray-900 hover:bg-blue-600 text-white text-xs font-semibold rounded-xl transition-all duration-300'>
            Browse Cars
          </Link>
        </div>
        ...
        >
          ...
          <span className={`block w-5 h-0.5 bg-gray-700 transition-all duration-300 ${menuOpen ? 'opacity-0 w-0' : ''}`} />
          <span className={`block w-5 h-0.5 bg-gray-700 transition-all duration-300 origin-center ${menuOpen ? '-rotate-45 -translate-y-2' : ''}`} />
        </button>
      </div>
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden fixed left-0 right-0 top-[53px] bg-white shadow-xl overflow-hidden transition-all duration-300 ease-in-out ${menuOpen ? 'max-h-[650px] opacity-100' : 'max-h-0 opacity-0'}`}>
        <div className='px-5 py-5 space-y-1'>
          ...
          {user && (
            <div className='flex items-center gap-3 p-3 bg-blue-50 rounded-2xl mb-3'>
              ...
              {user.role === 'admin' && (
                <span className='text-xs bg-blue-600 text-white px-2 py-0.5 rounded-full font-semibold ml-auto flex-shrink-0'>Admin</span>
              )}
            </div>
          )}
          ...
          {[
            ...
            { to: '/cars', label: 'Browse Cars', icon: 'M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0zM13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2-2h8z' },
            { to: '/', label: 'About', icon: 'M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
            { to: '/', label: 'Contact', icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
          ].map((link, i) => (
            <Link
              key={i}
              to={link.to}
          ...
          <div className='pt-3 mt-1 border-t border-gray-100 space-y-2'>
            {user ? (
              ...
              <div className='flex flex-col gap-2'>
                <Link to='/login' onClick={() => setMenuOpen(false)} className='w-full text-center py-2.5 rounded-xl text-sm font-semibold text-blue-600 border border-blue-100 bg-blue-50 hover:bg-blue-100 transition-colors'>
                  Sign In
                </Link>
                <Link to='/register' onClick={() => setMenuOpen(false)} className='w-full text-center py-2.5 rounded-xl text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 transition-colors'>
                  Create Account
                </Link>
              </div>
            )}
